...
- **Faster than C** -- 1.05–1.20x faster than raw C (libpq) on every operation. Even pipelined C batch INSERT: bsql 721 us vs C 727 us. See [benchmarks](https://github.com/smir-ant/bsql/blob/main/bench/README.md).
