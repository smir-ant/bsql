...
- Pedantic-audit Tier 4 sweep batch 4 (Cluster A pilot) — 2026-05-19 — **5 pilot files cleaned, pattern established for the remaining sweep**.
  ...
  **Remaining Cluster A scope** (sized for follow-up sessions, NOT closed):
  ...
  - dispatch.rs (176), decode.rs (155), ident.rs (131), lib.rs (126), action.rs (125), error.rs (105) — top six remaining mid-size.
  - state.rs (79), session_params.rs (73), buf.rs (64), wire.rs (61), write_buf.rs (52), push_command.rs (49), reply_id.rs (43), row_stream.rs (39) — mid-size cluster (note reply_id and row_stream contain Tier-3 audit #17 / #59 anchors that must be preserved like the state_setter.rs audit-#26 anchors).
  - 14 smaller files with 17-29 refs each.
  Total remaining: ~1870 refs across ~27 files. Recommended: ≤5 files per session to keep per-comment judgement sharp.
