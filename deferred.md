...
| DEF-210 | **Tier-1 audit findings (architect-driven 2026-04-28)** — full closure detail moved to §D Phase 1c entry below; this row stays in §A only as a pointer + open follow-ups. **CLOSED in §D**: SR-01 Path C/D, SR-02, SR-03, SR-04, SR-05, SR-06, SR-07, ML-01, ML-03, BS-11, CF-02 (12 sub-items including re-audit elevation). **Open follow-ups**: REC-06 SCRAM Box consolidation (3-Box → 1; ~40 LoC, alloc-count win). **Acknowledged-as-policy**: BS-01 `panic = "abort"` zeroize gap; BS-02 transitive `unsafe` in `simdutf8`/`heapless`/`sha2` deps per CREDO §11. | Tier-2 by-discipline → tier-1 by-construction at 12 sites; see §D for per-site detail. | Closure of "стеклянная архитектура" risks. | §D CLOSED for SR/ML/BS/CF batch (2026-04-28). REC-06 PROPOSED (low priority). |
