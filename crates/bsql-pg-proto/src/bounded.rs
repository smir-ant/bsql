//! DEF-203 — bounded unsigned integers with niche-optimised `Option`.
//!
...
impl<const MAX: usize> BoundedU16<MAX> {
    ...
    ///
    /// ```
    /// use bsql_pg_proto::bounded::BoundedU16;
...
///
/// ```
/// use bsql_pg_proto::bounded_u16;
/// let five: bsql_pg_proto::bounded::BoundedU16<2048> = bounded_u16!(2048, 5);
/// assert_eq!(five.get(), 5);
/// ```
///
/// ```compile_fail
/// use bsql_pg_proto::bounded_u16;
/// let too_big: bsql_pg_proto::bounded::BoundedU16<2048> = bounded_u16!(2048, 2049);
/// ```
#[macro_export]
