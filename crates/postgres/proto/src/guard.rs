...
///
/// ```compile_fail
/// use bsql_postgres_proto::{PgCommand, PgProtocol, WriteBuf};
/// use bsql_postgres_proto::reply_id::{PingKind, ReplyId};
...
///
/// ```compile_fail
/// use bsql_postgres_proto::{FetchRows, PgProtocol, PortalName, StmtName, WriteBuf};
/// use bsql_postgres_proto::reply_id::{QueryKind, ReplyId};
/// use core::num::NonZeroU64;
///
/// let mut proto = PgProtocol::new();
/// let mut wb = WriteBuf::new();
...
///
/// ```compile_fail
/// use bsql_postgres_proto::PgProtocol;
///
/// let mut proto = PgProtocol::new();
