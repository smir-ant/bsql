...
#[diagnostic::on_unimplemented(
    ...
    label = "valid parameter types are those that implement `EncodeBinary` (e.g. `i16`, `i32`, `i64`, `u32`, `bool`, `f32`, `f64`, `&str`, `&[u8]`, `Uuid`, `Timestamptz`, `Timestamp`, `Json`, `Jsonb`, `Numeric`, or a `&[T]` array) or `Option<T>` over such a type",
