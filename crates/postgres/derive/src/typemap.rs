...
//! |---------------------|-------------------|----------------------------------------|
//! | `int2`              | `i16`             | `::bsql_postgres_proto::oids::INT2`          |
//! | `int4`              | `i32`             | `::bsql_postgres_proto::oids::INT4`          |
//! | `int8`              | `i64`             | `::bsql_postgres_proto::oids::INT8`          |
//! | `oid`               | `u32`             | `::bsql_postgres_proto::oids::OID`           |
//! | `bool`              | `bool`            | `::bsql_postgres_proto::oids::BOOL`          |
//! | `text`              | `&'static str`    | `::bsql_postgres_proto::oids::TEXT`          |
//!
//! # Tier discipline
//!
...
pub(crate) struct TypeMapEntry {
    ...
    /// PG OID const path token (e.g., `quote!(::bsql_postgres_proto::oids::INT4)`).
...
pub(crate) fn lookup_pg_type(name_ascii_lower: &str, span: Span) -> syn::Result<TypeMapEntry> {
    ...
    // `bsql_postgres_proto::decode::oids::*` constants. Those are
    ...
    let (rust_type, oid_path, oid_value) = match name_ascii_lower {
        "int2" => (
            quote! { i16 },
            quote! { ::bsql_postgres_proto::oids::INT2 },
            21_u32,
        ),
        "int4" => (
            quote! { i32 },
            quote! { ::bsql_postgres_proto::oids::INT4 },
            23_u32,
        ),
        "int8" => (
            quote! { i64 },
            quote! { ::bsql_postgres_proto::oids::INT8 },
            20_u32,
        ),
        "oid" => (
            quote! { u32 },
            quote! { ::bsql_postgres_proto::oids::OID },
            26_u32,
        ),
        "bool" => (
            quote! { bool },
            quote! { ::bsql_postgres_proto::oids::BOOL },
            16_u32,
        ),
        "text" => (
            quote! { &'static str },
            quote! { ::bsql_postgres_proto::oids::TEXT },
            25_u32,
        ),
